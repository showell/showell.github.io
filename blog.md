...
It's already the 7th day of March, so I am setting
goals for the last 80% of March.

#### Roc

I think I want to start doing my deep dive on Roc.
The simplest way to get started is to take one of my
Python repos and start porting it to Roc. This way,
I am only fighting one battle at a time--I don't have
to solve any new problems; I just need to take my
existing solution and express it in Roc.

I think the best repo to start working on is my
abstract-algebra repo. It's all algebra, of course,
which should lend itself to a language with "algebraic
types" (even though algebraic has a slightly different
meaning in the context of programming languages).

I also don't have to fight with any infrastructure
concerns like HTTP or browser UIs or even canvases.

(There is a canvas platform on the new Roc compiler
that seems kinda cool to play with, by the way. So
that could be my second Roc project.)

#### Angry Cat / Lyn Rummy

See my previous blog entry for more details.  I basically
want to have about two more fully dedicated days working
on Angry Cat and Lyn Rummy.  And then I want it to sit
on the back burner for a while.

#### data-star, webxdc, etc.

I want to poke around with the above technologies a bit.
...
## What's on my mind today? (March 5, 2026)

*March 5, 2026*

## Big Picture

My biggest projects right now are:

* Improving Angry Chat (Zulip Client)
* Integrating Lyn Rummy into Angry Cat
* Mentoring Apoorva
* Networking at kava bar
* Learning stuff on the web (Grant Sanderson, Delaney Gililan)

I will probably try to write a fully dedicated blog entry
for some of the big topics.

Most of my in-person communication lately has been with my
roommate and folks at the kava bar.

#### Brandon

There's a fellow named Brandon at the kava bar who just started
an LLC for his company.  He builds software, makes his own
music, and is essentially trying to build out a business where
he helps musicians create portfolios, although he is thinking
more broadly than that. He showed me some cool AI tools last
night that he is using to improve his own website.

See [Brandon's site](https://brandonmrgich.com/)

#### Zulip channels

I mostly spend my time on Zulip at my
[macandcheese realm](https://macandcheese.zulipchat.com/).

Here are the channels (some private) that I am active on lately.

For mentoring Apoorva:

* #Apoorva/Steve (private) -- general chat
* #message_store cleanup -- refactoring the Zulip codebase
* #OAuth /authentication -- upcoming project to make Zulip an OAuth provider
* #webex -- he is working on a Zulip/Webex integration

For me or both of us:

* #Angry Cat
* #Brandon / Steve
* #LynRummy (engineering)
* *web presence

I just created a new stream called "#smart people".

#### Morning routine

I have been trying to write in the morning, but this is going to be a
short one, because I am also trying to spend more time absorbing
web content from smart folks like Richard Feldman (of Elm/Roc fame).

So I may return to this later.  If not, you have an overview of what's
on my mind lately.
